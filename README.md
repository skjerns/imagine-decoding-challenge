...
1. To get started, download the data from https://doi.org/10.5281/zenodo.17351690. Use `wget` or `curl` for faster speed `wget "https://zenodo.org/records/17351690/files/imagine_decoding_challenge.zip?download=1"`
